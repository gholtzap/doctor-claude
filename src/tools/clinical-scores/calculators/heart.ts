...
import {
  HEART_AGE_HIGH_THRESHOLD,
  HEART_AGE_MODERATE_THRESHOLD,
  HEART_RISK_FACTORS_HIGH_THRESHOLD,
  HEART_RISK_FACTORS_LOW_THRESHOLD,
} from '../constants.js';

export function calculateHEART(inputs: z.infer<typeof HEARTInputSchema>): ScoreResult {
  let score = 0;
